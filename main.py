...
try:
    ...
    MAX_CONCURRENCY = int(get_env_cleaned("MAX_CONCURRENCY", "30")) # Increased default suggestion
    ...
    MAX_BATCH_SIZE = int(get_env_cleaned("MAX_BATCH_SIZE", "75")) # Increased default suggestion
...
async def send_email(
    ...
    try:
        ...
        if smtp_config['start_tls'] or smtp_config['use_tls']:
             ...
             if retries == 0:
                 safe_log('warning', f"TLS certificate verification is [bold red]DISABLED[/] for {smtp_config['host']} ({smtp_email})")
